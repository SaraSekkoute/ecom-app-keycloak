...
const routes: Routes = [
  //Vérifie si l'utilisateur est authentifié avant d'accéder à cette route
  //Spécifie les rôles requis pour accéder à cette route (vide ici, donc accessible à tous les utilisateurs authentifiés)
